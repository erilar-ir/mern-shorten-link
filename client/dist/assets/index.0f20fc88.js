...
import { a as axios, c as createAsyncThunk, b as createSlice, d as configureStore, R as React, L as Link, r as react, M, u as useDispatch, e as useHistory, f as useSelector, g as useParams, C as Chart, h as CategoryScale, i as LinearScale, B as BarElement, p as plugin_title, j as plugin_tooltip, k as plugin_legend, A as ArcElement, D as Doughnut, l as randomColor, P as PointElement, m as LineElement, T as TimeScale, n as TimeSeriesScale, o as Bar, q as DateTime, S as Switch, s as Route, t as Redirect, v as useLocation, N as NavLink, w as BrowserRouter, x as ReactDOM, y as Provider } from "./vendor.f91fd75f.js";
...
const { clearError, setAuthError } = authSlice.actions;
...
/*\r
    @license\r
    Copyright (c) 2014 The Polymer Project Authors. All rights reserved.\r
    This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt\r
    The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt\r
    The complete set of contributors may be found at http://polymer.github.io/CONTRIBUTORS.txt\r
    Code distributed by Google as part of the polymer project is also\r
 ...
 * Constants:\r
 *      STROKEWIDTH = 3px\r
 *      ARCSIZE     = 270 degrees (amount of circle the arc takes up)\r
 *      ARCTIME     = 1333ms (time it takes to expand and contract arc)\r
 *      ARCSTARTROT = 216 degrees (how much the start location of the arc\r
 *                                should rotate each time, 216 gives us a\r
 *                                5 pointed star shape (it's 360/5 * 3).\r
 *                                For a 7 pointed star, we might do\r
 *                                360/7 * 3 = 154.286)\r
 *      CONTAINERWIDTH = 28px\r
 *      SHRINK_TIME = 400ms\r
 */
.preloader-wrapper {
  display: inline-block;
...
/**\r
 * IMPORTANT NOTE ABOUT CSS ANIMATION PROPERTIES (keanulee):\r
 *\r
 * iOS Safari (tested on iOS 8.1) does not handle animation-delay very well - it doesn't\r
 * guarantee that the animation will start _exactly_ after that value. So we avoid using\r
 * animation-delay and instead set custom keyframes for each color (as redundant as it\r
 * seems).\r
 *\r
 * We write out each animation in full (instead of separating animation-name,\r
 * animation-duration, etc.) because under the polyfill, Safari does not recognize those\r
 * specific properties properly, treats them as -webkit-animation, and overrides the\r
 * other animation rules. See https://github.com/Polymer/platform/issues/53.\r
 */
...
/**\r
 * Patch the gap that appear between the two adjacent div.circle-clipper while the\r
 * spinner is rotating (appears on Chrome 38, Safari 7.1, and IE 11).\r
 */
.gap-patch {
  position: absolute;
  top: 0;
...
var app = "";
const WelcomePage = () => {
  return /* @__PURE__ */ React.createElement("h4", null, "Welcome Page");
};
var linksPage = ".links-page {\r\n\r\n}\r\n.add-button-col {\r\n\r\n}\r\n.links-col {\r\n\r\n}\r\n.links-page .modal-trigger{\r\n\r\n}\r\n";
...
var message_hook = ".success-toast {\r\n    background-color: #0f9d58;\r\n}\r\n.warning-toast {\r\n    background-color: darkorange;\r\n}\r\n.error-toast {\r\n    background-color: darkred;\r\n}\r\n\r\n";
const useMessage = () => {
...
var modal_hook = ".confirm-delete-c {\r\n    width: max-content;\r\n}\r\n.confirm-delete-c .modal-title{\r\n    margin-right: 1.5rem;\r\n}\r\n\r\n";
var modal_hoc = ".modal .closer {\r\n    color: rgba(0, 0, 0, 0.87) !important;\r\n    position: absolute;\r\n    right: 0;\r\n    top: 0;\r\n    margin: 0;\r\n    padding: 0;\r\n}\r\n.modal-header {\r\n    padding-bottom: -2rem;\r\n}\r\n.modal-title {\r\n    margin-top: 1rem !important;\r\n    margin-left: 1.5rem;\r\n    color: rgba(0, 0, 0, 0.87);\r\n}\r\n.modal-content {\r\n    color: rgba(0, 0, 0, 0.87) !important;\r\n}\r\n.modal-content input {\r\n    line-height: 3em !important;\r\n    border-bottom: 1px solid #9e9e9e !important;\r\n}\r\n.modal-trigger {\r\n    display: flex;\r\n    flex-direction: row;\r\n    justify-content: center;\r\n    align-items: center;\r\n    line-height: 1.5rem;\r\n}\r\n.modal-trigger i {\r\n    /*box-sizing: border-box;*/\r\n    /*margin: .3rem .3rem 0 0;*/\r\n    /*margin-top: 2px;*/\r\n    margin-right: .3rem;\r\n}\r\n.modal-trigger>span {\r\n    display: flex;\r\n    flex-direction: row;\r\n    align-items: center;\r\n    justify-content: center;\r\n    line-height: 1.5rem;\r\n}\r\n.modal-button-text {\r\n    white-space: nowrap;\r\n    width: 0;\r\n    opacity: 0.5;\r\n    transform: scaleX(0);\r\n    transition: transform ease-in-out 300ms, width ease-in-out 300ms, opacity ease-in-out 300ms;\r\n    transform-origin: left;\r\n    /* hide all text on modal buttons*/\r\n    /*display: none;*/\r\n}\r\n.modal-trigger:hover span {\r\n    /*width: fit-content;*/\r\n}\r\n.modal-trigger:hover .modal-button-text {\r\n    /*display: block!important;*/\r\n    white-space: nowrap;\r\n    width: 4rem;\r\n    opacity: 1;\r\n    transform: scaleX(1);\r\n    /* hide all text on modal buttons*/\r\n    /*display: none;*/\r\n}\r\n\r\n";
...
var assignLinksCard = ".links-card {\r\n    /*padding: 5px 10px;*/\r\n    box-sizing: border-box;\r\n}\r\n.links-list {\r\n    margin-bottom: 10px;\r\n}\r\n.links-list card {\r\n    padding: 0;\r\n    margin: 0;\r\n}\r\n.link-item {\r\n    position: relative;\r\n    /*line-height: 2.5rem;*/\r\n    display: flex;\r\n    /*align-items: center;*/\r\n    justify-content: left;\r\n    /*margin: 5px 10px;*/\r\n    overflow: hidden;\r\n}\r\n.assign-link-item {\r\n    position: relative;\r\n    display: flex;\r\n    justify-content: left;\r\n    overflow: hidden;\r\n}\r\n.link-item .assign-link {\r\n    margin: 0;\r\n    padding: 0;\r\n    position: relative;\r\n    height:auto;\r\n}\r\n.link-item .edit-link {\r\n    margin: 0;\r\n    padding: 0;\r\n    position: relative;\r\n    height:inherit;\r\n}\r\n.link-item .edit-link a{\r\n    padding-left: .8rem;\r\n    padding-right: .4rem;\r\n    margin: 0;\r\n    position: relative;\r\n    height:100%;\r\n}\r\n.edit-link>div {\r\n    height: 100%;\r\n}\r\n.link-item button {\r\n    margin: 0;\r\n    position: relative;\r\n    height:100%;\r\n    /*top: -5px;*/\r\n    /*margin: 0;*/\r\n    /*padding: 0;*/\r\n}\r\n.link-names {\r\n    /*margin: 0;*/\r\n    /*padding-left: 10px;*/\r\n    display: flex;\r\n    flex-direction:column;\r\n    width: available;\r\n}\r\n.link-names span {\r\n    position: relative;\r\n    padding-left: 10px;\r\n    font-size: .9rem;\r\n    line-height: 1.5rem;\r\n    width:auto;\r\n    overflow: hidden;\r\n}\r\n.link-names .from {\r\n    font-weight: bold;\r\n}\r\n.link-names .from span{\r\n    font-weight: 500;\r\n}\r\n.link-names .to {\r\n    color:darkslategray;\r\n    font-weight: 500;\r\n}\r\n.link-names .to span{\r\n    color:grey;\r\n    font-weight: normal;\r\n}\r\n";
...
var confirm_hoc = ".confirm-container {\r\n    display: flex;\r\n    flex-direction: row;\r\n    justify-content: center;\r\n}\r\n.confirm-container button {\r\n    width: 45%;\r\n}\r\n";
...
const DetailsPage = () => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, link && /* @__PURE__ */ React.createElement(LinkCard, {
    openInNewTab,
    link
  }));
};
...
var groupsManagement = ".group-list {\r\n    position: relative;\r\n    /*width: 80%;*/\r\n}\r\n@media (min-width: 768px) {\r\n\r\n}\r\n\r\n.group-item {\r\n    height: 2.7rem;\r\n    /*display: flex;*/\r\n    /*flex-direction: row;*/\r\n    /*justify-content: space-between;*/\r\n    /*align-items: center;*/\r\n    margin-bottom: 5px;\r\n}\r\n\r\n.group-name {\r\n    position: relative;\r\n    height: fit-content;\r\n    /*width: 70%;*/\r\n}\r\n\r\n.group-tools {\r\n    display: flex;\r\n    flex-direction: row;\r\n    justify-content: right;\r\n    align-items: center;\r\n    /*margin-left: 20px;*/\r\n}\r\n.group-tools button {\r\n    margin-right: 5px;\r\n}\r\n";
const CreateGroup = () => {
  const dispatch = useDispatch();
  const [form, setForm] = react.exports.useState({
    name: "",
...
const ErrorView = ({ err }) => {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "medium material-icons red-text lighten-1"
  }, "error_outline"), /* @__PURE__ */ React.createElement("p", null, "Something went wrong."));
};
...
var groupDetails = ".group-row {\r\n    gap: 2rem;\r\n}\r\n.back-to-console {\r\n    display: flex;\r\n    justify-content: left;\r\n    align-items: center;\r\n    width: fit-content;\r\n    color: teal;\r\n}\r\n.back-to-console:hover {\r\n    color: lightskyblue;\r\n}\r\n.back-to-console i{\r\n    position: relative;\r\n}\r\n.back-to-console p{\r\n    margin-left: 5px;\r\n}\r\n.button-group {\r\n    display: flex;\r\n    flex-direction: row;\r\n\r\n}\r\n.button-group button,a {\r\n    margin-right: 10px;\r\n}\r\n";
var groupStatistics = ".group-stat {\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    align-items: center;\r\n    padding: 0 1.5rem 0 1.5rem;\r\n    overflow: paged-x;\r\n    height: 50vh;\r\n    min-height: 25rem;\r\n}\r\n.group-stat.empty {\r\n    height:30vh;\r\n    min-height: 15rem;\r\n}\r\n";
...
var dashboardPage = "\r\n.dashboard-page {\r\n    /*    min-height: 56px;\r\n*/\r\n    height:  calc(100vh - 56px);\r\n    min-height: calc(100vh - 56px);\r\n    max-height: calc(100vh - 56px);\r\n    /*width:100vw;*/\r\n    /*overflow: hidden;*/\r\n}\r\n@media only screen and (min-width: 601px) {\r\n    /*        height: calc(40vh - 64px);\r\n\r\n*/\r\n    .dashboard-page {\r\n        height: calc(100vh - 64px);\r\n        min-height: calc(100vh - 64px);\r\n        max-height: calc(100vh - 64px);\r\n    }\r\n}\r\n\r\n.dashboard-page .individual-stats{\r\n    margin-bottom: 0;\r\n}\r\n.dashboard-heading {\r\n    padding: 0 0.75rem;\r\n    display: flex;\r\n    justify-content: start;\r\n    align-items: start;\r\n    /*gap: 1rem;*/\r\n    margin-bottom:0;\r\n}\r\n.dashboard-heading h4 {\r\n    margin-top: 1.75rem;\r\n}\r\n.dashboard-heading select {\r\n\r\n    margin: 1.5rem 0 1rem 0.75rem;\r\n    border: none;\r\n    font-size: 2rem !important;\r\n    color: #26a69a;\r\n    position: relative;\r\n    cursor: pointer;\r\n    background-color: transparent;\r\n    border-bottom: 1px solid #9e9e9e;\r\n    outline: none;\r\n    height: 3rem;\r\n    /*width: 100%;*/\r\n    padding: 0;\r\n\r\n\r\n}\r\n.dashboard-heading select:focus{\r\n    border-bottom: 1px solid #26a69a;\r\n}\r\n.dashboard-heading select option {\r\n    border: none;\r\n    font-size: 1.5rem;\r\n    background: none !important;\r\n}\r\n.dashboard-heading select option:hover,option:focus {\r\n    border: none;\r\n    font-size: 1.5rem;\r\n    background-color: rgba(0, 0, 0, 0.08) !important;\r\n}\r\n.dashboard-page .two-weeks-stat {\r\n    position: relative;\r\n    height: calc((100vh - 64px -  4.508rem)*0.4);\r\n    /*height: calc(40vh - 64px - 4.508rem)*/\r\n    /*height: calc(40vh - 64px);*/\r\n    min-height: 22.5rem;\r\n}\r\n\r\n";
...
var topPerformers = ".top-performers {\r\n    padding-top: 1rem;\r\n    position: relative;\r\n}\r\n\r\n.top-performers div {\r\n    /*margin-top: 1.5rem;*/\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: start;\r\n    width: 100%;\r\n}\r\n\r\n@media (min-width: 992px) {\r\n    .top-performers div {\r\n        margin-top: 1.5rem;\r\n    }\r\n}\r\n\r\n@media (max-width: 601px) {\r\n    .top-performers {\r\n        padding-top: 0;\r\n        padding-bottom: 0;\r\n    }\r\n\r\n    .top-performers div {\r\n        margin-top: 1.5rem;\r\n    }\r\n}\r\n\r\n.top-performers div i {\r\n    color: teal;\r\n    margin-right: .5rem;\r\n}\r\n\r\n/*.top-performers:hover div i {*/\r\n/*    color: teal;*/\r\n/*}*/\r\n\r\n.top-performers .top-content {\r\n    position: relative;\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: start;\r\n    justify-content: center;\r\n}\r\n\r\n.top-performers .top-data {\r\n    font-size: 1.8rem;\r\n    line-height: 1.8rem;\r\n}\r\n\r\n.top-performers .top-header {\r\n    font-size: .8rem;\r\n    line-height: 1.2rem;\r\n    text-transform: uppercase;\r\n}\r\n";
...
var oneLinkStats = ".one-link-stats {\r\n    margin-bottom: 0;\r\n}\r\n\r\n.one-link-stats .collection-item {\r\n    padding: 0;\r\n    cursor: pointer;\r\n    transition: background-color .3s;\r\n}\r\n\r\n.one-link-stats .collection-item:hover, .collection-item:focus {\r\n    background-color: rgba(0, 0, 0, 0.05);\r\n}\r\n\r\n.one-link-stats .collection-item.active:hover, .collection-item.active:focus {\r\n    background-color: #26a69a;\r\n}\r\n\r\n.one-link-stats .collection-item.active button {\r\n    color: #fff;\r\n}\r\n\r\n.link-stat-btn {\r\n    padding: 1.2rem 1.5rem;\r\n    text-align: left;\r\n    background: none;\r\n    box-sizing: border-box;\r\n    margin: 0;\r\n    width: 100%;\r\n    height: 100%;\r\n    line-height: 1.8rem;\r\n}\r\n\r\n.link-stat-btn:hover, .link-stat-btn:focus {\r\n    background: none;\r\n}\r\n";
var linkStat = ".link-stats {\r\n    /*overflow-y: scroll;*/\r\n    /*overflow-x: hidden;*/\r\n}\r\n.link-short {\r\n    font-size:.9rem;\r\n    font-weight: 500;\r\n    margin-bottom: 0;\r\n    margin-top: 0.2rem;\r\n}\r\n.link-title {\r\n    margin-top: 0;\r\n    margin-bottom: 0;\r\n}\r\n.clicks {\r\n    font-weight: bold;\r\n}\r\n\r\n.clicks span {\r\n    font-weight: normal;\r\n    font-size: .8rem;\r\n    line-height: 1rem;\r\n    text-transform: uppercase;\r\n}\r\n.created {\r\n    font-weight: normal;\r\n    font-size: .65rem;\r\n    line-height: 1.2rem;\r\n    text-transform: uppercase;\r\n    margin-bottom: 0;\r\n}\r\n.link-stats-charts {\r\n    /*display: flex;*/\r\n    /*justify-content: center;*/\r\n    /*align-items: end;*/\r\n    margin-bottom: 0;\r\n    /*padding-bottom: 1rem;*/\r\n}\r\n.link-stats-charts .row {\r\n    margin-bottom:0;\r\n}\r\n.countries-chart {\r\n    height: 18rem;\r\n    min-height: 18rem;\r\n}\r\n.cities-chart {\r\n    height: 18rem;\r\n    min-height: 18rem;\r\n}\r\n";
Chart.register(CategoryScale, LinearScale, BarElement, plugin_title, plugin_tooltip, plugin_legend, ArcElement);
...
const DashboardPage = () => {
  ...
  if (linkList.length === 0) {
    return /* @__PURE__ */ React.createElement("p", null, "To view dashboard and statistics make some links with clicks");
  }
...
var header = "@import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500&display=swap');\r\n.header{\r\n}\r\n.brand-logo {\r\n    font-family: 'Orbitron', sans-serif;\r\n    font-weight: 500;\r\n    margin: 0 1rem;\r\n}\r\n.header nav ul {\r\n}\r\n.header nav ul li a {\r\n    padding-left: 1.5rem;\r\n}\r\n.header nav ul li:hover {\r\n    background-color: rgba(0, 0, 0, 0.1);\r\n}\r\n.header nav ul a:hover {\r\n    background-color: rgba(0, 0, 0, 0.0);\r\n}\r\n/*.dropdown-content ul{*/\r\n/*    width: fit-content;*/\r\n/*}*/\r\n/*.dropdown-content li {*/\r\n/*    width: fit-content;*/\r\n/*}*/\r\n.dropdown-content li a{\r\n    white-space: nowrap;\r\n    text-wrap: none;\r\n}\r\n";
const Header = () => {
  const isAuthenticated = useSelector(selectIsAuthenticated);
  const dispatch = useDispatch();
  const history2 = useHistory();
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ React.createElement("div", {
      ...
      to: "/auth"
    }, "Sign In | Sign Up"))), /* @__PURE__ */ React.createElement("nav", null, /* @__PURE__ */ React.createElement("div", {
  ...
  }, "Logout"))), /* @__PURE__ */ React.createElement("nav", null, /* @__PURE__ */ React.createElement("div", {
