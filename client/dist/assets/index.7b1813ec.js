...
import { a as axios, c as createAsyncThunk, b as createSlice, d as configureStore, r as react, M as M$1, R as React, L as Link, u as useDispatch, e as useHistory, f as useSelector, g as useParams, N as NavLink, C as Chart, h as CategoryScale, i as LinearScale, B as BarElement, p as plugin_title, j as plugin_tooltip, k as plugin_legend, A as ArcElement, D as Doughnut, l as randomColor, P as PointElement, m as LineElement, T as TimeScale, n as TimeSeriesScale, o as Bar, q as DateTime, S as Switch, s as Route, t as Redirect, v as useLocation, w as BrowserRouter, x as ReactDOM, y as Provider } from "./vendor.710d9962.js";
...
`;
var app = "\r\n";
var welcomePage = "@import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500&display=swap');\r\n\r\n\r\n#root {\r\n    display: flex;\r\n    min-height: 100vh;\r\n    flex-direction: column;\r\n}\r\n\r\n\r\nmain {\r\n    flex: 1 0 auto;\r\n}\r\n\r\n\r\n.welcome {\r\n    font-family: 'Orbitron', sans-serif;\r\n    text-transform: uppercase;\r\n    text-align: center;\r\n\r\n}\r\n\r\n\r\n.welcome::before,.welcome::after {\r\n    content: '|';\r\n    color: orange;\r\n}\r\n\r\n\r\n.brand-name {\r\n    font-family: 'Orbitron', sans-serif;\r\n    font-weight: 500;\r\n    /*text-transform: uppercase;*/\r\n    margin: 0 0.3rem;\r\n}\r\n\r\n\r\n.use-instruction {\r\n    padding: .5rem;\r\n    border-radius: .3rem;\r\n}\r\n\r\n\r\n.page-footer{\r\n    padding-top: 0;\r\n}\r\n\r\n\r\n.footer-copyright {\r\n    background-color: transparent !important;\r\n}\r\n\r\n\r\n.tap-target-content {\r\n    /*padding:8rem 4.5rem 5rem 6rem !important;*/\r\n }\r\n";
const WelcomePage = () => {
  const infoRef = react.exports.useRef();
  const openInfo = () => {
    const infoInstance = M$1.TapTarget.getInstance(infoRef.current);
    infoInstance.open();
  };
  react.exports.useEffect(() => {
    M$1.TapTarget.init(infoRef.current);
  }, []);
...
const useMessage = () => {
  return react.exports.useCallback((text, type) => {
    if (M$1 && text) {
      switch (type) {
        case "success":
          M$1.toast({ html: text, classes: "success-toast", displayLength: 2e3 });
          break;
        case "warn":
          M$1.toast({ html: text, classes: "warning-toast", displayLength: 2e3 });
          break;
        case "error":
          M$1.toast({ html: text, classes: "error-toast", displayLength: 2e3 });
          break;
        default:
          M$1.toast({ html: text });
      }
...
const withModal = (WrappedComponent, _a) => {
  ...
  react.exports.useEffect(() => {
    ...
    M$1.Modal.init(modal.current, options);
    if (!props.noTooltip) {
      M$1.Tooltip.init(tooltip.current);
    }
  }, []);
  const { modalButton, modalHeader, modalButtonClass, modalContainerClass, tooltipText } = props;
  const modalClose = () => {
    const modalInstance = M$1.Modal.getInstance(modal.current);
    modalInstance.close();
  };
...
const Header = () => {
  ...
  react.exports.useEffect(() => {
    ...
    if (sideBarElement.length !== 0) {
      M$1.Sidenav.init(sideBarElement, { draggable: true });
    }
    const dropdownTrigger = document.querySelectorAll(".dropdown-trigger");
    if (dropdownTrigger.length !== 0) {
      M$1.Dropdown.init(dropdownTrigger, { coverTrigger: false, constrainWidth: false });
    }
  }, []);
  if (!isAuthenticated) {
    return /* @__PURE__ */ React.createElement("div", {
