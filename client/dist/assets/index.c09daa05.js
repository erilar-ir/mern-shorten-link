...
import { a as axios, r as react, R as React, L as Link, u as useHistory, b as useParams, S as Switch, c as Route, d as Redirect, e as api, N as NavLink, B as BrowserRouter, f as ReactDOM } from "./vendor.b82e5f7f.js";
...
p();
var index = `/*@import "~materialize-css/dist/css/materialize.min.css";*/
body {
  margin: 0;
...
`;
var materialize_min = `/*!\r
 * Materialize v1.0.0-rc.2 (http://materializecss.com)\r
...
$api.interceptors.request.use((config) => {
  const localStore = JSON.parse(localStorage.getItem(storageName$1));
...
const useHttp = () => {
  ...
  const request = react.exports.useCallback(async (url, method = "GET", body = null) => {
  ...
  const clearError = react.exports.useCallback(async () => {
    await setError(null);
  }, []);
  return { loading, error, request, clearError };
};
var message_hook = ".success {\r\n    background-color: #0f9d58;\r\n}\r\n.warning {\r\n    background-color: darkorange;\r\n}\r\n.error {\r\n    background-color: darkred;\r\n}\r\n\r\n";
const useMessage = () => {
...
const LinksList = ({ links }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    className: "links-list"
  }, /* @__PURE__ */ React.createElement("table", null, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "#"), /* @__PURE__ */ React.createElement("th", null, "Destination"), /* @__PURE__ */ React.createElement("th", null, "Short link"), /* @__PURE__ */ React.createElement("th", null, "Clicks"), /* @__PURE__ */ React.createElement("th", null, "Details"))), /* @__PURE__ */ React.createElement("tbody", null, links.map((link, index2) => {
    const { to, from, _id, clicks } = link;
    return /* @__PURE__ */ React.createElement("tr", {
      key: _id
    }, /* @__PURE__ */ React.createElement("td", null, index2 + 1), /* @__PURE__ */ React.createElement("td", null, from), /* @__PURE__ */ React.createElement("td", null, to), /* @__PURE__ */ React.createElement("td", null, clicks), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(Link, {
      to: `/details/${_id}`
...
const LinksPage = () => {
  const { logout } = react.exports.useContext(AuthContext);
  const message = useMessage();
  const { loading, request } = useHttp();
  const [links, setLinks] = react.exports.useState([]);
  const getLinks = react.exports.useCallback(async () => {
    try {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, !loading && /* @__PURE__ */ React.createElement(LinksList, {
    links
  }));
};
var createPage = "";
const CreatePage = () => {
  const message = useMessage();
  const { isAuthenticated, checkAuth } = react.exports.useContext(AuthContext);
  const { request, loading } = useHttp();
  const history = useHistory();
  const [link, setLink] = react.exports.useState("");
  react.exports.useEffect(async () => {
    await checkAuth();
  }, [checkAuth]);
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    htmlFor: "{'link'}"
  }, "Enter link")), /* @__PURE__ */ React.createElement("div", {
    className: "buttons"
...
const LinkCard = ({ link, removeLink, openInNewTab }) => {
  const { to, from, clicks, date } = link;
  return /* @__PURE__ */ React.createElement("div", {
    className: "link-card"
  }, /* @__PURE__ */ React.createElement("h2", null, "Link info"), /* @__PURE__ */ React.createElement("p", null, "Short link: ", /* @__PURE__ */ React.createElement("span", {
    className: "blue-text text-darken-2 span-link short",
    onClick: () => openInNewTab(to)
  }, to)), /* @__PURE__ */ React.createElement("p", null, "Destination link: ", /* @__PURE__ */ React.createElement("span", {
    className: "blue-text text-darken-2 span-link",
    onClick: () => openInNewTab(from)
  }, from)), /* @__PURE__ */ React.createElement("p", null, "Link clicks: ", /* @__PURE__ */ React.createElement("strong", null, clicks)), /* @__PURE__ */ React.createElement("p", null, "Create date: ", /* @__PURE__ */ React.createElement("strong", null, new Date(+date).toLocaleDateString())), /* @__PURE__ */ React.createElement("button", {
...
const AuthService = () => {
  ...
  const login = react.exports.useCallback(async (email, password) => {
    return request("/api/auth/login", "POST", { email, password }).catch((err) => {
      return Promise.reject(err);
    });
  }, []);
  const register = react.exports.useCallback(async (email, password) => {
    return request("/api/auth/register", "POST", { email, password }).catch((err) => {
      return Promise.reject(err);
    });
  }, []);
  const logout = react.exports.useCallback(async () => {
...
const GroupService = () => {
  ...
  const createGroup = async (name) => {
    return await request(`/api/group/create`, "POST", { name });
  };
  const removeGroup = async (id) => {
    return await request(`/api/group/remove/${id}`, "DELETE");
  };
  const assignLinkToGroup = async (groupId, linkId) => {
    return await request(`/api/group/assign`, "PATCH", { groupId, linkId });
  };
  const withdrawLinkFromGroup = async (groupId, linkId) => {
    return await request(`/api/group/withdraw`, "PATCH", { groupId, linkId });
  };
...
const DetailsPage = () => {
  ...
  const [link, setLink] = react.exports.useState(null);
  const [linkClicks, setLinkClicks] = react.exports.useState(0);
  const history = useHistory();
  const linkId = useParams().id;
  const message = useMessage();
  const getLink = react.exports.useCallback(async () => {
    try {
      const link2 = await linkDetails(linkId).catch((error) => {
        history.push("/links");
  ...
  const removeLink = react.exports.useCallback(async () => {
    await deleteLink(linkId).then((data) => {
      history.push("/links");
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, !loading && link && /* @__PURE__ */ React.createElement(LinkCard, {
    openInNewTab,
    link,
    removeLink
  }));
};
var authPage = ".auth-page {\r\n\r\n}\r\n\r\n.auth-page .buttons .btn {\r\n    margin-right: 10px;\r\n}\r\n\r\n.auth-page .card-title {\r\n    /*font-weight: 500;*/\r\n}\r\n";
const AuthPage = () => {
  const auth = react.exports.useContext(AuthContext);
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, "Shorten the link"), /* @__PURE__ */ React.createElement("div", {
...
var userConsole = ".group-list {\r\n    position: relative;\r\n    width: 80%;\r\n}\r\n\r\n.group-item {\r\n    height: 2.7rem;\r\n    display: flex;\r\n    flex-direction: row;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    margin-bottom: 5px;\r\n}\r\n\r\n.group-name {\r\n    position: relative;\r\n    height: fit-content;\r\n    width: 70%;\r\n}\r\n\r\n.group-tools {\r\n    margin-left: 20px;\r\n}\r\n.group-tools button {\r\n    margin-right: 5px;\r\n}\r\n";
const CreateGroup = (props) => {
  const { createGroup } = GroupService();
  const { getUserGroups } = props;
  const [groupName, setGroupName] = react.exports.useState("");
  const message = useMessage();
  const enterPressHandler = async (event) => {
    if (event.key === "Enter") {
      await addGroup();
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h2", null, "Create new Group"), /* @__PURE__ */ React.createElement("div", {
    className: "input-field"
  }, /* @__PURE__ */ React.createElement("input", {
    type: "text",
    id: "groupName",
...
const GroupList = ({ groups, getUserGroups }) => {
  const message = useMessage();
  const history = useHistory();
  ...
  if (groups.length === 0) {
    return /* @__PURE__ */ React.createElement("p", null, "You have no groups yet");
  } else {
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "User Groups"), /* @__PURE__ */ React.createElement("ul", {
...
const UserConsole = () => {
  ...
  const getUserGroups = react.exports.useCallback(async () => {
    try {
  ...
  const groupsView = groups ? /* @__PURE__ */ React.createElement(GroupList, {
    groups,
    getUserGroups
  }) : /* @__PURE__ */ React.createElement(Loader, null);
  return /* @__PURE__ */ React.createElement("div", {
    className: "user-console"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "row"
  }, /* @__PURE__ */ React.createElement("div", {
    className: "col s6"
  }, groupsView), /* @__PURE__ */ React.createElement("div", {
    className: "col s6"
  }, /* @__PURE__ */ React.createElement(CreateGroup, {
    getUserGroups
  }))));
};
var groupCard = ".group-card{\r\n\r\n}\r\n.group-links {\r\n    margin-bottom: 2.5rem;\r\n}\r\n.group-link {\r\n    line-height: 2.5rem;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: left;\r\n    margin: 5px 10px;\r\n}\r\n.link-name {\r\n    margin-left: 10px;\r\n}\r\n";
const GroupCard = ({ group, withdrawLink }) => {
  const { loading } = useHttp();
  const { removeGroup } = GroupService();
  const history = useHistory();
  const message = useMessage();
  ...
  const renderGroupLinks = () => {
    ...
    return /* @__PURE__ */ React.createElement("ul", {
      ...
      return /* @__PURE__ */ React.createElement("li", {
        ...
        className: "btn  orange lighten-1 btn-small",
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, group == null ? void 0 : group.name), group && groupLinks, /* @__PURE__ */ React.createElement("button", {
    className: "btn red lighten-1",
    onClick: () => deleteGroup(groupId)
  }, "Delete Group"));
};
var linksCard = ".links-card {\r\n    /*padding: 5px 10px;*/\r\n}\r\n.links-list {\r\n    margin-bottom: 10px;\r\n}\r\n.link-item {\r\n    line-height: 2.5rem;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: left;\r\n    margin: 5px 10px;\r\n}\r\n.link-name {\r\n    margin-left: 10px;\r\n}\r\n";
const LinksCard = ({ group, assignLink }) => {
  const { logout } = react.exports.useContext(AuthContext);
  const { loading } = useHttp();
  const [links, setLinks] = react.exports.useState(null);
  ...
  const renderLinks = (links2) => {
    if (links2.length === 0) {
      return /* @__PURE__ */ React.createElement("p", null, "No links left to assign");
    }
    return /* @__PURE__ */ React.createElement("ul", {
      className: "links-list"
    }, links2.map((link) => {
  ...
  }, /* @__PURE__ */ React.createElement("h1", null, "Assign Links"), links && renderLinks(links));
};
var groupDetails = ".back-to-console {\r\n    display: flex;\r\n    justify-content: left;\r\n    align-items: center;\r\n    width: fit-content;\r\n    color: teal;\r\n}\r\n.back-to-console:hover {\r\n    color: lightskyblue;\r\n}\r\n.back-to-console i{\r\n    position: relative;\r\n}\r\n.back-to-console p{\r\n    margin-left: 5px;\r\n}\r\n";
const GroupDetails = () => {
  const { loading } = useHttp();
  const history = useHistory();
  const message = useMessage();
  const [group, setGroup] = react.exports.useState(null);
  const { getGroupDetails, assignLinkToGroup, withdrawLinkFromGroup } = GroupService();
  const groupId = useParams().id;
  react.exports.useEffect(async () => {
    await getGroup();
  }, []);
  const getGroup = react.exports.useCallback(async () => {
    try {
      const group2 = await getGroupDetails(groupId).catch((error) => {
        history.push("/uconsole");
        message(error.message, "error");
      });
      await setGroup(group2);
    } catch (e) {
      history.push("/uconsole");
      message(e.message, "error");
      console.log(e);
  ...
  const assignLink = react.exports.useCallback(async (linkId) => {
    try {
  ...
  const withdrawLink = react.exports.useCallback(async (linkId) => {
    try {
  ...
  const availableLinks = group ? /* @__PURE__ */ React.createElement(LinksCard, {
    group,
    assignLink
  }) : /* @__PURE__ */ React.createElement(Loader, null);
  return /* @__PURE__ */ React.createElement("div", {
...
const Routes = (isAuthenticated) => {
  if (!isAuthenticated) {
    return /* @__PURE__ */ React.createElement(Switch, null, /* @__PURE__ */ React.createElement(Route, {
      path: "/",
      exact: true
    }, /* @__PURE__ */ React.createElement(AuthPage, null)), /* @__PURE__ */ React.createElement(Redirect, {
      to: "/"
    }));
  }
  return /* @__PURE__ */ React.createElement(Switch, null, /* @__PURE__ */ React.createElement(Route, {
    ...
    path: "/uconsole"
  }, /* @__PURE__ */ React.createElement(UserConsole, null)), /* @__PURE__ */ React.createElement(Redirect, {
    to: "/create"
  }));
};
const storageName = "userData";
const useAuth = () => {
  const [token, setToken] = react.exports.useState(null);
  const [userId, setUserId] = react.exports.useState(null);
  const [ready, setReady] = react.exports.useState(false);
  const message = useMessage();
  const login = react.exports.useCallback((jwtToken, id) => {
    setToken(jwtToken);
    setUserId(id);
    const userData = {
      userId: id,
  ...
  const checkAuth = react.exports.useCallback(async () => {
    const refreshToken = api.get("refreshToken");
    if (refreshToken) {
      try {
        const response = await axios.get("/api/auth/refresh", { withCredentials: true });
        const userData = response.data;
...
const Header = () => {
  ...
  }, "Shorten Link"), /* @__PURE__ */ React.createElement("ul", {
    id: "nav-mobile",
    className: "right hide-on-med-and-down"
  }, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(NavLink, {
    to: "/create"
  }, "Create")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(NavLink, {
    to: "/links"
  }, "Links")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(NavLink, {
    to: "/uconsole"
  }, "User Console")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("a", {
    href: "/",
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(AuthContext.Provider, {
    value: { token, userId, login, logout, isAuthenticated, checkAuth }
  }, /* @__PURE__ */ React.createElement(BrowserRouter, null, isAuthenticated && /* @__PURE__ */ React.createElement(Header, null), /* @__PURE__ */ React.createElement("div", {
    className: "container"
  }, routes)));
}
