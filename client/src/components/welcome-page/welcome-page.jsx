                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <p className="flow-text">
                            This project was created for educational purposes with intention to learn
                            MERN stack and have a fun with programming.
                        </p>
                        <p className="flow-text">
                            It uses Node.js and Express.js to run everything on server side. Cloud MongoDB used as
                            database. There is custom
                            authorization logic with access and refresh tokens to keep user logged in safely. App uses
                            email verification to activate user after sign up. User should confirm activation by link in
                            email within 7 days after registration. After 7 days unactivated user account and all data
                            (short links and clicks) generated by unactivated user will be automatically deleted from
                            app.
                        </p>
                        <p className="flow-text">
                            Client app created using React framework. Redux used for state management on client side
                            here. For UI components there is
                        ...
                        <p className="flow-text">
                            For the awesome bots thanks to <a className={'teal-text'}
                                                              href={'https://www.freepik.com/upklyak'}
                                                              rel={'noopener noreferrer'}>upklyak from
                            www.freepik.com</a>
                        </p>
                    </div>
                </div>
